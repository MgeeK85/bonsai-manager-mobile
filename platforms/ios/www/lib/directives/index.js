 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Users/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use User.bonsais.findById() instead.
            "prototype$__findById__bonsais": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Users/:id/bonsais/:fk",
              method: "GET",
            },

            // INTERNAL. Use User.bonsais.destroyById() instead.
            "prototype$__destroyById__bonsais": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Users/:id/bonsais/:fk",
            ...
            // INTERNAL. Use User.bonsais.updateById() instead.
            "prototype$__updateById__bonsais": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Users/:id/bonsais/:fk",
            ...
            // INTERNAL. Use User.bonsais() instead.
            "prototype$__get__bonsais": {
              isArray: true,
              url: urlBase + "/Users/:id/bonsais",
              method: "GET",
            },

            // INTERNAL. Use User.bonsais.create() instead.
            "prototype$__create__bonsais": {
              url: urlBase + "/Users/:id/bonsais",
              method: "POST",
            },

            // INTERNAL. Use User.bonsais.destroyAll() instead.
            "prototype$__delete__bonsais": {
              url: urlBase + "/Users/:id/bonsais",
              method: "DELETE",
            },

            // INTERNAL. Use User.bonsais.count() instead.
            "prototype$__count__bonsais": {
              url: urlBase + "/Users/:id/bonsais/count",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.User.bonsais
     * @header lbServices.User.bonsais
     * @object
     * @description
     *
     * The object `User.bonsais` groups methods
     * manipulating `Bonsai` instances related to `User`.
     *
     * Call {@link lbServices.User#bonsais User.bonsais()}
     * to query all related instances.
     */
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Bonsai` object.)
             * </em>
             */
        R.bonsais = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::get::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#count
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             * Counts bonsais of User.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
             ...
             *  - `count` – `{number=}` -
             */
        R.bonsais.count = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::count::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#create
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             * Creates a new instance in bonsais of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
             ...
             * </em>
             */
        R.bonsais.create = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::create::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#createMany
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             ...
             * </em>
             */
        R.bonsais.createMany = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::createMany::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#destroyAll
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             * Deletes all bonsais of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
             ...
             * This method returns no data.
             */
        R.bonsais.destroyAll = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::delete::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#destroyById
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             * Delete a related item by id for bonsais.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
             ...
             * This method returns no data.
             */
        R.bonsais.destroyById = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::destroyById::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#findById
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             * Find a related item by id for bonsais.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
             ...
             * </em>
             */
        R.bonsais.findById = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::findById::User::bonsais"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.User.bonsais#updateById
             * @methodOf lbServices.User.bonsais
             *
             * @description
             *
             * Update a related item by id for bonsais.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
             ...
             * </em>
             */
        R.bonsais.updateById = function() {
          var TargetResource = $injector.get("Bonsai");
          var action = TargetResource["::updateById::User::bonsais"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Bonsai
 * @header lbServices.Bonsai
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Bonsai` model.
 *
 * ## Example
 *
 * See
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Bonsais/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#create
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#createMany
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#patchOrCreate
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#replaceOrCreate
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/Bonsais/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#upsertWithWhere
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/Bonsais/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#exists
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/Bonsais/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#findById
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/Bonsais/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#replaceById
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/Bonsais/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#find
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#findOne
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/Bonsais/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#updateAll
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/Bonsais/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#deleteById
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/Bonsais/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Bonsai#prototype$patchAttributes
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#createChangeStream
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/Bonsais/change-stream",
              method: "POST",
            },

            // INTERNAL. Use User.bonsais.findById() instead.
            "::findById::User::bonsais": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Users/:id/bonsais/:fk",
            ...
            // INTERNAL. Use User.bonsais.createMany() instead.
            "::createMany::User::bonsais": {
              isArray: true,
              url: urlBase + "/Users/:id/bonsais",
              method: "POST",
            },
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#updateOrCreate
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#patchOrCreateWithWhere
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#destroyById
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#removeById
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Bonsai#updateAttributes
             * @methodOf lbServices.Bonsai
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Bonsai#modelName
        * @propertyOf lbServices.Bonsai
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Bonsai`.
        */
